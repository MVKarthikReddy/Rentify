    ...
    <section className="py-12">
       <div className="container mx-auto px-4">
           ...
           <p className="text-lg text-slate-600 leading-relaxed">
               Welcome to Rentify, your trusted partner in real estate. We're committed to revolutionizing the
               way you buy, sell, or rent properties, ensuring a seamless and rewarding experience for every
               client.
           </p>
           <p className="text-lg text-slate-600 leading-relaxed mt-4">
               At Rentify, we believe that finding your dream home should be exciting, not overwhelming.
           ...
           <p className="text-lg text-slate-600 leading-relaxed mt-4">
               ...
               providing expert advice, personalized recommendations, and unparalleled support. With Rentify,
